...
time ./babble.py -s -d -C -m 20 -c 5 -j stores/sharon.sqlite > html/char20.json

echo "18 character chains:"
time ./babble.py -s -d -C -m 18 -c 5 -j stores/sharon.sqlite > html/char18.json

# echo "15 character chains:"
# time ./babble.py -s -d -C -m 15 -c 20 -j stores/sharon.sqlite > html/char15.json

echo "4 word chains:"
time ./babble.py -s -d -m 4 -c 5 -j stores/sharon.sqlite > html/word4.json
